...
class Constants(object):
    ...
    TIP_UNIT = 'PRTC' if Env.banano() else 'Nano'
    ...
    REPRESENTATIVE='prtc_3xphw6kekgxnnm996r86uh7kekfm3hjzeam69d5amrh5q3c9bx1urfqd9haz' if Env.banano() else 'nano_3o7uzba8b9e1wqu5ziwpruteyrs3scyqr761x7ke6w1xctohxfh5du75qgaj'
